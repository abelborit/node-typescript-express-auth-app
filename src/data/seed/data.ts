...
export const seedData = {
  ...
  /* aquí por ejemplo no está el id del usuario que creó cada categoría (porque para crear una categoría es necesario tener el id del usuario) y por eso vamos a hacer algunos procedimientos para llenar o completar el seed */
  categories: [
    { name: "Driven" },
    { name: "Till" },
    { name: "Shout" },
